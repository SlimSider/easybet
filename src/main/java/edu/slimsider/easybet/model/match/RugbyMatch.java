...
public class RugbyMatch extends Match {
    ...
    public RugbyMatch(String home, String away, String competition, Date date, boolean active, Set<Event> events, String sport, int final_home_score, int final_away_score) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RugbyMatch)) return false;
        if (!super.equals(o)) return false;
        RugbyMatch that = (RugbyMatch) o;
